...
def login():
    if request.method == 'POST':
        ...
        connection = psycopg2.connect("postgresql://raunak:p3w3jJ5ID9ep5rMve2UhKg@iss-project-8924.8nk.gcp-asia-southeast1.cockroachlabs.cloud:26257/user_data?sslmode=verify-full")
...
def edit():
    ...
    # connect to the database
    conn = psycopg2.connect("postgresql://raunak:p3w3jJ5ID9ep5rMve2UhKg@iss-project-8924.8nk.gcp-asia-southeast1.cockroachlabs.cloud:26257/user_data?sslmode=verify-full")
    cursor = conn.cursor()
